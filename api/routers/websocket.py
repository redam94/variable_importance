...
class ConnectionManager:
    ...
    async def connect(
        self, websocket: WebSocket, workflow_id: str, user: Optional[User] = None
    ) -> Connection:
...
class WebSocketProgressEmitter:
    ...
    async def emit(
        self, event_type: str, stage: str, message: str, data: Optional[dict] = None
    ):
...
async def get_connections() -> dict:
    ...
    return {
        ...
        "workflows": {wf: len(conns) for wf, conns in manager._connections.items()},
    }
