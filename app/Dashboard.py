...
with col2:
    if st.button("💬 Quick Chat", use_container_width=True):
        st.switch_page("pages/3_Streaming_Chat.py")
with col3:
    if st.button("🎨 View Artifacts", use_container_width=True):
        st.switch_page("pages/4_Artifacts.py")

with col4:
    if st.button("📚 Browse Workflows", use_container_width=True):
        st.switch_page("pages/6_Workflows.py")
